    ...
    "<div class='nav-links' style='display: block;' >"+
        ...
        "<div class='dropdown'>" +
            ...
            "<div class='dropdown-content'>" +
                "<a href='/view/sandbox.html'>Particles</a>" +
                "<a href='/view/sandbox2.html'>Sand Piling 2D</a>" +
                "<a href='/view/sandbox_Astar.html'>Pathfinding</a>" +
                "<a href='/view/sandbox_Golden.html'>Golden Spiral</a>"  +
                "<a href='/view/sandbox_Three.html'>Three (In Progress 🛠️) </a>"  +
            "</div>" +
        "</div>" +
